...
<link href="{{ asset('vendors/base/vendors.bundle.css') }}" rel="stylesheet">
...
<!-- begin:: Page -->
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-2" id="m_login" style="background-image: url(/app/media/img/bg/railway-image.jpg);">
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img src="/app/media/img/logos/trili-logo.png">
							</a>
						</div>
						<div class="m-login__signin">
							<div class="m-login__head">
								<h1 style="color:#c4c5d6;text-align: center;font-weight: bold;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;">
